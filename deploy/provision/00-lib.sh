#!/usr/bin/env bash
# Shared helpers for the wgcp provisioning steps. Sourced by every NN-*.sh, not
...
WGCP_LOG_DIR="${WGCP_LOG_DIR:-/var/log/wgcp-provision}"
...
RUBY_PREFIX="${WGCP_RUBY_PREFIX:-/opt/rubies/ruby-4.0.6}"
