...
describe WGCP::IPAM do
  ...
  it "raises when the subnet is exhausted" do
    ...
    expect { WGCP::IPAM.allocate(@db) }.to raise_exception(RuntimeError, message: be =~ /exhausted/)
  end
end
